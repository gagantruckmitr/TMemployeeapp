    ...
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">Add New Callback Request</h3>
                    <ul class="breadcrumb">
                        ...
                        <form action="{{ route('admin.callback-requests.store') }}" method="POST">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" 
                                               ...
                                               value="{{ old('request_date_time', now()->format('Y-m-d\TH:i')) }}" 
                                               required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('app_type') is-invalid @enderror" 
                                            ...
                                            <option value="driver" {{ old('app_type') == 'driver' ? 'selected' : '' }}>Driver App</option>
                                            <option value="transporter" {{ old('app_type') == 'transporter' ? 'selected' : '' }}>Transporter App</option>
                                        </select>
                                        @error('app_type')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                            ...
                            <div class="form-group text-center">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save"></i> Create Callback Request
                                </button>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateContactReasons() {
        ...
        const oldValue = '{{ old("contact_reason") }}';
        if (oldValue) {
