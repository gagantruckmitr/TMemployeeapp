...
<div class="page-wrapper">
    ...
    <div class="content container-fluid">
        <div class="row">
            <h3>Health & Hygiene Video List</h3>
           @foreach ($HealthHygine as $key => $value)
                <div class="col-lg-4 col-md-4 col-sm-6 col-12 mb-4">
                    <h3 class="vdo-topic">{{ $value->topic_name }}</h3>
                    <div class="card video-card p-0">
                        <a href="#" class="video-link"
                           data-video-id=""
                           data-video-url="/public/{{ $value->video }}"
                        ...
                        <p class="text-center p-2">{{ $value->video_topic_name }}</p>
                    </div>
                </div>
            @endforeach
