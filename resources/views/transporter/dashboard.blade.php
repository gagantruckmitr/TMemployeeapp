                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-sub-header">
                               <h3 class="page-title"><!--<span>{{$user->name}}, </span>--><span>{{$user->Transport_Name!=''?$user->Transport_Name.',':''}}</span> Welcome To TruckMitr</h3>
							
                                <ul class="breadcrumb">
								
                                    <li class="breadcrumb-item"><a href="">Transporter</a></li>
                        ...
                        <div class="card bg-comman w-100">
                            <div class="card-body">
                                <div class="db-widgets d-flex justify-content-between align-items-center">
                                    <div class="db-info">
                                        <h6><a class="dshbrd-link" href="{{url('transporter/job')}}">Total Job Posted</a></h6>
                                        <h3>{{$totaljob}}</h3>
                                    </div>
                                    <div class="db-icons">
                    ...
                    <div class="col-xl-4 col-sm-6 col-12 d-flex">
                        <div class="card bg-comman w-100">
                            <div class="card-body">
                                <div class="db-widgets d-flex justify-content-between align-items-center">
                                    <div class="db-info">
                                        <h6><a class="dshbrd-link" href="{{url('transporter/apply-job')}}">Total Applicants</a></h6>
                                        <h3>{{$totaljob}}</h3>
                                    </div>
                                    <div class="db-icons">
                                        <i class="fas fa-briefcase"></i>
