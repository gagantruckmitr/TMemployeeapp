...
<body>
    ...
    <table class="invoice-details no-border" style="width:100%; margin-bottom:15px;">
        <tr>
            <td style="width:50%; vertical-align:top;">
                ...
                <p><strong>Subscription Type:</strong> {{ $user_role }} {{$payment_type}}</p>
            </td>
            <td style="width:50%; vertical-align:top;">
                <p><strong>Name:</strong> {{ $user->name ?? '_________________' }}</p>
    ...
    <div class="footer mt-5">
        ...
        <ol>
            <li>The subscription fee of &#8377;49 is non-refundable and valid for the period as defined by TruckMitr
                policies.
            </li>
