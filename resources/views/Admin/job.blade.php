...
<style>
	.btn-fixed-width {
  width: 210px; /* or whatever fixed width you want */
}
</style>
...
<form action="{{ route('admin.export.jobs') }}" method="GET" style="display:inline-block;">
    ...
    <button class="btn btn-success btn-sm btn-fixed-width" type="submit">
     <i class="fas fa-download"></i>   Job List 
    </button>
</form>
								
<a href="{{ route('admin.master-jobs.export') }}" class="btn btn-primary mb-3 btn-fixed-width">
 <i class="fas fa-download"></i>    Master Job Report
</a>
