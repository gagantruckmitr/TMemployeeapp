        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="page-sub-header">
                    ...
                    <!--<ul class="breadcrumb">-->
                    <!--   <li class="breadcrumb-item active">All Topic</li>-->
                    <!--</ul>-->
                </div>
                </div>
            </div>
             ...
             <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                          <form action="{{ url('admin/create_module_topic') }}" method="POST" class="container mt-4">
                                {{ csrf_field() }}
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="video" class="form-label">Module Name <span class="text-danger">*</span></label>
                                             <select name="mu_id" class="form-select">
                                            ...
                                            @if($errors->has('mu_id'))
                                                <div class="text-danger">{{ $errors->first('mu_id') }}</div>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="video" class="form-label">Topic Name <span class="text-danger">*</span></label>
                                            <input type="text" name="topic_name" id="topic_name" class="form-control">
                                            @if($errors->has('topic_name'))
                                                <div class="text-danger">{{ $errors->first('topic_name') }}</div>
                                            @endif
                                        </div>
                                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped" id="dfUsageTable">
                            ...
                            @foreach ($Topic as $key => $value)
								...
								<td><a class="delete-btn" href="{{url('admin/module_topic/delete')}}/{{ $value->video_topic_id}}" onclick="return confirm('Are you sure you want to delete this Record?');">
								 Delete
								</a>
								</td>
                            </tr>
