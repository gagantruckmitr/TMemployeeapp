                ...
                <div class="card-body">
                    <div class="page-header">
                        <div class="row align-items-center d-flex">
                            ...
                            <h3 class="page-title">Expired Jobs List</h3>
<form action="{{ route('admin.export.expired-jobs') }}" method="GET" style="display:inline-block;">
...
<td>{{ $value->transporter_mobile ?? '-' }}</td>
    ...
    {{ $value->Job_Description }}
								...
								<span 
                                        ...
                                        class="badge badge-danger">Expired
                                    </span>
								</td>
