...
class _ConnectedCallsScreenState extends State<ConnectedCallsScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          _ConnectedCallsHeader(
            contactCount: _connectedContacts?.length ?? 0,
          ...
          Expanded(
            child: _isLoading
                ...
                : RefreshIndicator(
                    onRefresh: _refreshData,
                    child: (_connectedContacts?.isEmpty ?? true)
                        ? const _EmptyStateWidget()
                        : _ContactsList(
                            contacts: _connectedContacts!,
...
class _ConnectedCallsHeader extends StatelessWidget {
  final int contactCount;
  final VoidCallback onRefresh;
  final bool isRefreshing;

  const _ConnectedCallsHeader({
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  '$contactCount successful connections',
