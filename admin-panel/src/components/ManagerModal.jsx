...
const ManagerModal = ({ manager, onClose }) => {
  ...
  const saveMutation = useMutation({
    mutationFn: async (data) => {
      if (manager) {
        return axios.put(`${API_BASE_URL}/admin_managers_api.php`, { ...data, id: manager.id });
      }
      return axios.post(`${API_BASE_URL}/admin_managers_api.php`, data);
    },
    onSuccess: () => {
