<?php
/**
 * TruckMitr API Configuration - PRODUCTION VERSION FOR PLESK
 * This file should be renamed to config.php on the server
 */
...
// ============================================
// DATABASE CONFIGURATION - PLESK PRODUCTION
// ============================================
// These credentials match your live database on Plesk server
define('DB_HOST', 'localhost');  // Changed from 127.0.0.1 to localhost for Plesk
define('DB_PORT', '3306');
...
function getDBConnection() {
    try {
        ...
        echo json_encode([
            ...
            'error' => null // Never show details in production
        ]);
        exit();
    }
}
