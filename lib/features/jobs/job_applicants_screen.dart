              ...
              children: [
                Stack(
                  ...
                  children: [
                    ...
                    // Match Making Done Badge
                    if (driver.matchStatus?.toLowerCase() == 'match making done')
                      Positioned(
                        top: -8,
                        right: -8,
                        child: Container(
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      // Show telecaller name if match making done
                      if (driver.matchStatus?.toLowerCase() == 'match making done' && 
                          driver.telecallerName != null && 
                          driver.telecallerName!.isNotEmpty)
                        Padding(
                          padding: const EdgeInsets.only(top: 2),
                          child: Text(
                            'By: ${driver.telecallerName}',
                            style: TextStyle(
                              fontSize: 10,
