...
class TelecallerLoginPage extends StatefulWidget {
  const TelecallerLoginPage({super.key});

  @override
  State<TelecallerLoginPage> createState() => _TelecallerLoginPageState();
}

class _TelecallerLoginPageState extends State<TelecallerLoginPage> {
  ...
  Widget _buildWelcomeText() {
    return Column(
      children: [
        ...
        Text(
              'Sign in to your telecaller account',
              style: TextStyle(
                fontSize: 15,
    ...
    if (_formKey.currentState?.validate() ?? false) {
      ...
      try {
        ...
        if (result.isSuccess) {
          ...
          await RealAuthService.instance.updateUserRole('telecaller');
