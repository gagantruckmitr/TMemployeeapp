...
class _RoleSelectionPageState extends State<RoleSelectionPage> {
  ...
  final List<RoleOption> roles = [
    ...
    RoleOption(
      ...
      description:
          'Onboard shops, manage territory, and track field operations',
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Icon(role.icon, size: 36, color: role.color),
                ),
    ...
    return Container(
          ...
          decoration: BoxDecoration(
            ...
            gradient: selectedRole != null
                ? LinearGradient(
                    colors: [const Color(0xFF3D4A7A), const Color(0xFF5C5C99)],
                  )
                : null,
          ...
          child: Material(
            ...
            child: InkWell(
              borderRadius: BorderRadius.circular(16),
              onTap: selectedRole != null && !_isLoading
                  ? _handleContinue
                  : null,
              child: Center(
                child: _isLoading
