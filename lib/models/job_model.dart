class JobModel {
  ...
  final String transporterCreatedAt;
  ...
  JobModel({
    ...
    required this.transporterCreatedAt,
  ...
  factory JobModel.fromJson(Map<String, dynamic> json) {
    // Parse assignedTo - handle both int and string from API
    int? parsedAssignedTo;
    final assignedToRaw = json['assignedTo'] ?? json['assigned_to'];
    if (assignedToRaw != null) {
      if (assignedToRaw is int) {
        parsedAssignedTo = assignedToRaw;
      } else if (assignedToRaw is String) {
        parsedAssignedTo = int.tryParse(assignedToRaw);
      }
    }
    
    // Parse assignedToName
    final parsedAssignedToName = json['assignedToName'] ?? json['assigned_to_name'];
    
    // Debug logging
    print('=== JobModel.fromJson ===');
    print('Job: ${json['jobId'] ?? json['job_id']}');
    print('Raw assignedTo: $assignedToRaw (${assignedToRaw.runtimeType})');
    print('Parsed assignedTo: $parsedAssignedTo (${parsedAssignedTo.runtimeType})');
    print('Parsed assignedToName: "$parsedAssignedToName"');
    print('========================');
    ...
    return JobModel(
      ...
      transporterCreatedAt: json['transporterCreatedAt'] ?? '',
      ...
      assignedToName: parsedAssignedToName,
      isAssignedToMe: json['isAssignedToMe'] == true || json['isAssignedToMe'] == 1,
    );
  }
