...
class SocialMediaFeedbackService {
  ...
  static final SocialMediaFeedbackService instance = SocialMediaFeedbackService._();

  Future<Map<String, dynamic>> submitFeedback({
    required SocialMediaLead lead,
    ...
    try {
      ...
      if (response.statusCode == 200) {
        try {
          ...
          // JSON decode error - return raw response for debugging
          return {
            'success': false,
  ...
  Future<List<Map<String, dynamic>>> fetchCallHistory() async {
    try {
      ...
      final uri = Uri.parse(
        '${ApiConfig.baseUrl}/social_media_feedback_api.php',
      ).replace(
        queryParameters: {
          'action': 'get_history',
