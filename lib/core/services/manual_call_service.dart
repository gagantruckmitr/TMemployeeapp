...
class ManualCallService {
  static String get _initiateCallUrl => ApiConfig.getLaravelApiUrl('manual-call');
  static String get _updateCallUrl => ApiConfig.getLaravelApiUrl('manual-call-update');
